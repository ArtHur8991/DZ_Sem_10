...
API_TOKEN='5943919400:AAHEy1Vhujm3PDr5yKHxsK0NVhWZzM761pM'
...
def startMessage(message):
    ...
    bot.send_message(message.chat.id,f"Привет, {name}! Я Teлефонный бот, у меня есть все твои контакты. Чем тебе помочь?", parse_mode='html', reply_markup=keyboard_1)
